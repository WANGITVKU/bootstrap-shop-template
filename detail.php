                    ...
                    if ($conn->connect_error) {
                        ...
                        ?>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="size-<?php echo $value;?>" name="size" value="<?php echo $value; ?>"  >
        ...
        <div class="row px-xl-5">
            <div class="col">
                ...
                <div class="tab-content" >
                    ...
                    <div class="tab-pane fade" id="tab-pane-2"style="background-color: white">
