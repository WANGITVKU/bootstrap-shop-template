    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="row" action="xuly/xuly_ttcn.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
              <div class="form-group col-md-4">
                ...
                <input class="form-control" name="name" type="text" value="<?php echo $full_name ?>" required>
              </div>
              <div class="form-group col-md-4">
              ...
              <div class="form-group col-md-4">
                ...
                <input class="form-control" type="number" name="CCCD" required>
              </div>
          ...
          <input class="btn btn-save" type="submit"  name="submit" value="CẬP NHẬP THÔNG TIN">
