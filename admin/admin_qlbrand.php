                                ...
                                <?php
                                    ...
                                    while ($row= mysqli_fetch_array($kq)){
                                        ...
                                        <td class="align-middle" width="10"><input type="checkbox" name="check1" value="1"></td>
                                         <td class="align-middle"><?php echo $row['id_brand']   ?> <br></td>
                                         <td class="align-middle"><?php  echo $row['namebrand']   ?></td>
                                        ...
                                        <td>
                                          <button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
                                              ...
                                              onclick="myFunction('<?php echo $row['id_brand'] ?>')">
                                          <i class="fas fa-trash-alt"></i> 
                                                  </button>
                                        <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" onclick="window.location.href='sua_brand.php?id_brand=<?php echo $row['id_brand']; ?>'"><i class="fas fa-edit"></i>
                                        </button>
    ...
    <script>
        ...
        jQuery(function () {
            jQuery(".trash").click(function () {
                var id_brand = $(this).data("id_brand"); // Lấy giá trị id_sanpham từ thuộc tính data
