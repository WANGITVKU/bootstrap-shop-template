  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item active"><a href="admin_qlsp.php">Quản lý sản phẩm</a></li>
      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form id="form1" method="POST"  action="../admin/xuly/xuly_suasp.php" class="row" enctype="multipart/form-data">
              <div class="form-group col-md-3">
                <label class="control-label">Mã sản phẩm </label>
                <input class="form-control" type="text" name="idsp" placeholder="" value="<?php echo $row['id_sanpham']; ?>">
              </div>
...
<!-- 
              ...
              <textarea name="mo_ta" id="editor"><?php echo html_entity_decode($row['mo_ta']); ?></textarea>
              <script>
                  ClassicEditor
