  ...
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item active"><a href="admin_qlsp.php">Quản lý thương hiệu</a></li>
        <li class="breadcrumb-item ">Sửa thương hiệu</li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form id="form1" method="POST"  action="../admin/xuly/xuly_suabrand.php" class="row" enctype="multipart/form-data">
              <div class="form-group col-md-3">
                <label class="control-label">Mã danh mục</label>
                <input class="form-control" type="text" name="id_brand" placeholder="" value="<?php echo $row['id_brand']; ?>">
              </div>
              
              <div class="form-group col-md-3">
                <label class="control-label">Tên danh mục</label>
                <input class="form-control" type="text" name="name" value="<?php echo $row['namebrand']; ?>" >
              </div>
